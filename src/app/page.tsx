  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (view === "sign_up") {
        ...
        setMessage("Registrasi berhasil! Silakan cek email Anda untuk verifikasi (jika diaktifkan di Supabase), atau langsung login.");
        setView("sign_in");
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-black overflow-hidden m-4 rounded-[2rem]">
        ...
        <div className="absolute top-12 left-12 flex items-center gap-4">
          <span className="text-white text-xs font-bold tracking-widest uppercase">A Wise Quote</span>
          <div className="h-[1px] w-12 bg-white/50" />
        </div>
        <div className="absolute bottom-16 left-12 right-12">
          <h1 className={`${playfair.className} text-6xl font-bold text-white mb-6 leading-[1.1]`}>
            Get<br />
            Everything<br />
            You Want
          </h1>
      ...
      <div className="flex-1 flex flex-col pt-12 pb-8 px-8 sm:px-16 lg:px-24 relative overflow-y-auto">
        <div className="w-full max-w-[380px] mx-auto flex flex-col min-h-full">
          ...
          <div className="flex items-center justify-center gap-2 mb-12">
            ...
            <span className="text-lg font-bold text-black tracking-tight">Cogie</span>
          </div>

          {/* Header */}
          <div className="text-center mb-8">
            <h2 className={`${playfair.className} text-4xl font-semibold text-gray-900 mb-3`}>
                ...
                <div className="flex items-center justify-between mt-1 mb-2">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <div className="relative flex items-center justify-center">
                      <input type="checkbox" className="peer appearance-none w-4 h-4 border border-gray-300 rounded bg-white checked:bg-black checked:border-black focus:outline-none focus:ring-2 focus:ring-black/20 transition-all cursor-pointer" />
                    ...
                    <span className="text-xs font-semibold text-gray-600 group-hover:text-gray-800 transition-colors">Remember me</span>
                  </label>
                  <a href="#" className="text-xs font-semibold text-gray-800 hover:underline">Forgot Password</a>
                </div>
              )}
          ...
          <div className="mt-8 text-center text-sm text-gray-500 pb-4">
            {view === "sign_in" ? (
              <p>Don&apos;t have an account? <button onClick={() => setView("sign_up")} className="font-bold text-black hover:underline">Sign Up</button></p>
            ) : (
              <p>Already have an account? <button onClick={() => setView("sign_in")} className="font-bold text-black hover:underline">Sign In</button></p>
            )}
          </div>
        </div>
      </div>
